...
import tvm
trace = torch.jit.trace(model, (img1_batch, img2_batch))
mod, params = relay.frontend.from_pytorch(trace, [("img1", img1_batch.shape), ("img2", img2_batch.shape)])
...
runtime.set_input("img1", img1_batch.numpy())
runtime.set_input("img2", img2_batch.numpy())
runtime.run()
